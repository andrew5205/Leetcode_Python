...
o = Solution()
print(o.distributeCandies([1,1,2,2,3,3]))
print(o.distributeCandies([1,1,2,3]))
print(o.distributeCandies([6,6,6,6]))

# Runtime: 664 ms, faster than 96.46% of Python online submissions for Distribute Candies.
# Memory Usage: 15.6 MB, less than 32.68% of Python online submissions for Distribute
